...
\begin{DoxyItemize}
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+Death (HP = 0)\+:\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+The game restarts from the beginning (Biome 0).
\item \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+Refresh\+:\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+Restarts only the current biome. Your inventory is restored to the one you had when you entered this biome.
